    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargoComponays", x => x.CargoCompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CargoDetailId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CargoSenderId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CargoDetails_CargoComponays_CargoCompanyId",
                        column: x => x.CargoCompanyId,
                        principalTable: "CargoComponays",
