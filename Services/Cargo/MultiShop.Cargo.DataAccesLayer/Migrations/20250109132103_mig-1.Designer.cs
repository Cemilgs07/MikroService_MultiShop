...
namespace MultiShop.Cargo.DataAccesLayer.Migrations
{
    ...
    [Migration("20250109132103_mig-1")]
    partial class mig1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiShop.Cargo.EntityLayer.Concrete.CargoComponay", b =>
                {
            ...
            modelBuilder.Entity("MultiShop.Cargo.EntityLayer.Concrete.CargoDetail", b =>
                {
                    ...
                    b.Property<string>("CargoSenderId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MultiShop.Cargo.EntityLayer.Concrete.CargoDetail", b =>
                {
                    b.HasOne("MultiShop.Cargo.EntityLayer.Concrete.CargoComponay", "CargoCompany")
                        .WithMany()
